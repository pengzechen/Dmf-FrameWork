...
/*	
	*						SERVER LOG MODEL
	*
	*	This model is for server log. When you call "log_init", 
	*	it will open a log file, and start a thread, it will write log
	*	when buffer is full.
	*/
...
void log_init() 
{
    ...
    printf("[SERVER: Info] log init successfully...\n");
}
