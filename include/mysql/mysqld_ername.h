...
{ "ER_AES_INVALID_KDF_NAME", 3235, "KDF method name is not valid. Please use hkdf or pbkdf2_hmac method name" },
{ "ER_AES_INVALID_KDF_ITERATIONS", 3236, "For KDF method pbkdf2_hmac iterations value less than 1000 or more than 65535 is not allowed due to security reasons. Please provide iterations >= 1000 and iterations < 65535" },
{ "WARN_AES_KEY_SIZE", 3237, "AES key size should be %d bytes length or secure KDF methods hkdf or pbkdf2_hmac should be used, please provide exact AES key size or use KDF methods for better security." },
{ "ER_AES_INVALID_KDF_OPTION_SIZE", 3238, "KDF option size is invalid, please provide valid size < %d bytes and not NULL" },
